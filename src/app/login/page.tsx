        ...
        <div className="lw-panel-content">
          ...
          {chatOpen ? (
            <div className="lw-panel" style={{ padding: 0, overflow: 'hidden', position: 'relative' }}>
              ...
              {chatApiKey ? (
                <iframe
                  src={`${CHAT_EMBED_BASE}/embed/chat?key=${chatApiKey}&bg=1a112e&accent=6a24fa&header=false${userId ? `&user_id=${encodeURIComponent(userId)}` : ''}${userName ? `&userName=${encodeURIComponent(userName)}` : ''}`}
                  style={{
                    width: '100%',
                    height: '650px',
                    border: 'none',
            ...
            <div className="lw-panel">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <button disabled className="lw-btn lw-btn-twitter" style={{ opacity: 0.4, cursor: 'not-allowed' }} title="X sign-in coming soon">
